...
<div id="primary" class="site-content">
	<div id="content" class="cart-page l-inner" role="main">
	...
	if ( have_posts() ) :
		...
		<article class="post" id="wc_<?php usces_page_name(); ?>">
			...
			<div id="customer-info">
				...
				<div class="cart_navi">
				<ol class="ucart">
						<li class="ucart "><?php _e( '1.Cart', 'usces' ); ?></li>
						<li class="ucart current"><?php _e( '2.Customer Info', 'usces' ); ?></li>
						<li class="ucart"><?php _e( '3.Deli. & Pay.', 'usces' ); ?></li>
						<li class="ucart" ><?php _e( '4.Confirm', 'usces' ); ?></li>
					</ol>
			</div>
					...
					<tr>
						...
						<tr>
							...
							if ( $member_regmode == 'editmemberfromcart' ) :
								?>
								<em><?php _e( '*', 'usces' ); ?></em><?php endif; ?><?php _e( 'password', 'usces' ); ?></th>
							<td colspan="2"><input name="customer[password1]" style="width:100px" type="password" value="<?php esc_attr_e( $usces_entries['customer']['password1'] ); ?>" autocomplete="new-password" />
																																		   <?php
																																			if ( $member_regmode != 'editmemberfromcart' ) {
						...
						<tr>
							...
							if ( $member_regmode == 'editmemberfromcart' ) :
								?>
								<em><?php _e( '*', 'usces' ); ?></em><?php endif; ?><?php _e( 'Password (confirm)', 'usces' ); ?></th>
							<td colspan="2"><input name="customer[password2]" style="width:100px" type="password" value="<?php esc_attr_e( $usces_entries['customer']['password2'] ); ?>" autocomplete="new-password" />
																																		   <?php
																																			if ( $member_regmode != 'editmemberfromcart' ) {
																																				_e( 'When you enroll newly, please fill it out.', 'usces' );}
																																			?>
