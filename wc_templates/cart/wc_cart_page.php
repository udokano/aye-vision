...
get_header();
?>
<div id="primary" class="site-content cart">
	...
	if ( have_posts() ) :
		...
		<article class="post" id="wc_<?php usces_page_name(); ?>">
			...
			<div class="cart_navi">
				<ol class="ucart">
						<li class="ucart current"><?php _e( '1.Cart', 'usces' ); ?></li>
						<li class="ucart"><?php _e( '2.Customer Info', 'usces' ); ?></li>
			...
			<?php if ( usces_is_cart() ) : ?>
				<div id="cart">
					<?php echo apply_filters( 'usces_theme_filter_upbutton', '<div class="up-button">' . __( 'Press the `update` button when you change the amount of items.', 'usces' ) . '<input name="upButton" type="submit" value="' . __( 'Quantity renewal', 'usces' ) . '" onclick="return uscesCart.upCart()" /></div>' ); ?>
					<table cellspacing="0" id="cart_table" class="cart-table">
						<thead>
						<tr>
						...
						<tr>
							...
							<th class="aright amount" colspan="2"><?php usces_crform( usces_total_price( 'return' ), true, false ); ?></th>
						<!-- 	<th class="stock"></th> -->
							<th class="action"></th>
						</tr>
						</tfoot>
