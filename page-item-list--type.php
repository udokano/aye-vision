...
<div class="l-breadcrumb">
	<ul class="l-inner l-breadcrumb__list">
		...
		<li class="l-breadcrumb__item">
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>item-type?item_cat=<?php echo esc_html( $show_item ); ?>" class="l-breadcrumb__link">
...
<ul class="l-inner item-anchor">
	<li class="item-anchor__item is-active js-item-ajax-btn" data-slug="all">全て</li>
		<li class="item-anchor__item js-item-ajax-btn" data-slug="1day">1day</li>
		<li class="item-anchor__item js-item-ajax-btn" data-slug="2week">2week</li>
</ul>
